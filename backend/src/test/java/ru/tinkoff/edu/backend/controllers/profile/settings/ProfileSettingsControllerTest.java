...
@WebMvcTest(value = ProfileSettingsController.class, excludeAutoConfiguration = SecurityAutoConfiguration.class)
...
class ProfileSettingsControllerTest {
    ...
    ObjectMapper objectMapperWithoutAnnotations = JsonMapper.builder()
            .disable(MapperFeature.USE_ANNOTATIONS)
            .build();

    UserEditMainInfoDTO userEditMainInfoDTO = new UserEditMainInfoDTO(
            "Ivan",
            "Ivanov",
            "Yovanovitch",
    ...
    void get_mainInfo_thenReturnObjectWithStatus200() throws Exception {
        ...
        mockMvc.perform(get("/api/user/profile/settings/" + id))
                .andDo(print())
    ...
    void put_mainInfo_thenReturnStatus200() throws Exception {
        ...
        mockMvc.perform(put("/api/user/profile/settings/" + id)
    ...
    void get_accountDetails_thenReturnObjectWithStatus200() throws Exception{
        ...
        mockMvc.perform(get("/api/user/profile/settings/account/" + id))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void put_editAccountDetails_thenReturnStatus200() throws Exception {
        ...
        mockMvc.perform(put("/api/user/profile/settings/account/" + id)
    ...
    void put_editAccountDetailsWithAnyException_thenReturnStatus400(RuntimeException exception) throws Exception {
        Long id = 1L;
        doThrow(exception)
                .when(profileService)
                .updateAccountDetailsUser(id, userEditAccountDTO);
    ...
    static Stream<Arguments> provideArgumentToMethod_editAccountDetailsWithAnyException() {
        return Stream.of(
            ...
            Arguments.of(new DifferentPasswordException("The new and the confirming password must match!")),
            Arguments.of(new OldPasswordRepeatNewPasswordException("The new password matches the old password!"))
        );
    }
    ...
    void get_userContacts_thenReturnStatus200() throws Exception {
        ...
        mockMvc.perform(get("/api/user/profile/settings/contacts/" + id))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void put_editUserContacts_thenReturnStatus200() throws Exception{
        ...
        mockMvc.perform(put("/api/user/profile/settings/contacts/" + id)
