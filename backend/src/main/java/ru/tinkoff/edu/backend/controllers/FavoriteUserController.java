...
@RestController
@Validated
@Tag(name = "Favorite Mentor Controller",
...
public class FavoriteUserController {
    ...
    public ResponseEntity<Void> addFavoriteMentor(@PathVariable Long userId, @PathVariable Long favoriteUserId) {
    ...
    public ResponseEntity<Void> deleteFavoriteMentor(@PathVariable Long userId, @PathVariable Long favoriteUserId) {
