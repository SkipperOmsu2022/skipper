...
public interface ProfileService {
    ...
    /**
     * Изменяет основную информацию о пользователе в базе данных.
     * Значения полей без аннотации @NotNull или @NotBlank стираются с базы данных, если их значение null.
     * Остальные поля просто перезаписываются.
     *
     * @param id идентификатор пользователя.
    ...
    /**
     * Изменяет контактную информацию о пользователе.
     * Значения полей стираются с базы данных, если их значение null.
     *
     * @param id идентификатор пользователя.
     * @param user объект с данными для обновления информации.
