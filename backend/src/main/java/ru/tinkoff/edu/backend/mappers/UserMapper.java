...
public class UserMapper {
  ...
  public static List<MentorListItemDTO> userToMentorListItemDTOs(List<User> users) {
    ...
    return users.stream().map(UserMapper::userToMentorListItemDTO).collect(Collectors.toList());
  }
  ...
  public static UserMentorProfileDTO userToUserMentorProfileDTO(
      User user, boolean isFavorite, List<Feedback> feedbacks) {
    if (user == null) {
      return null;
    }
